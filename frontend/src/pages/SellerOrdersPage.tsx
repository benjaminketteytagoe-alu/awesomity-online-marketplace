...
/**
 * Placeholder — the real orders list lands in Step 14.7 Block E.
 */
export function SellerOrdersPage() {
  return (
    <div className="flex flex-col items-center gap-3 rounded-xl border border-dashed border-border bg-surface/50 py-16 text-center">
      ...
      <h2 className="font-display text-lg font-medium">Orders</h2>
      <p className="max-w-sm text-sm text-muted-foreground">
        Order management lands in the next block. This placeholder
